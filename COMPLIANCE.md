...
Public-use boundary: Public page may use synthetic inputs only. Do not pass or store real patient context through URLs, browser history, screenshots, or service-worker-cached pages.
